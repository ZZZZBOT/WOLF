...
module.exports = bosco = async (bosco, mek) => {
	try {
		...
		const catl = (teks) => {
             res = bosco.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 400, "message": teks, "footerText": "*𝗭𝗘𝗗 𝗕𝗢𝗧*", "thumbnail": dfrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             bosco.relayWAMessage(res)
        }
       const catlo = (teks) => {
             res = bosco.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 70000, "message": teks, "footerText": "𝗭𝗘𝗗", thumbnail: fs.readFileSync('./ds.jpg'), "surface": 'CATALOG' }}, {quoted:mek})
             bosco.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = bosco.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/HEP90W2NX9Y4YISOzCu7AQ', "groupName": `𝗭𝗘𝗗'𝘀 𝗙𝗥𝗜𝗘𝗡𝗗𝗦`, "footerText": "*𝗭𝗘𝗗*", "jpegThumbnail": dfrply, "caption": teks}}, {quoted:fvideo})
            bosco.relayWAMessage(grup)
        }
        try {
		pporang = await bosco.getProfilePicture(`${sender.split('@')[0]}@s.whatsapp.net`)
		      } catch {
		pporang = 'https://www.linkpicture.com/q/IMG-20211219-WA0002.jpg'
		      }
        ...
        const reply = (teks) => {
	      bosco.sendMessage(from, teks, text, { thumbnail: denis, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: false, "externalAdReply": { "title": `${' '}𝗢𝗪𝗡𝗘𝗥 𝗜𝗦 𝗭𝗘𝗗${''}${''}`, "body": `𝗭𝗘𝗗 𝗪𝗛𝗧𝗦𝗔𝗣𝗣 𝗕𝗢𝗧`, "previewType": 'PHOTO', "thumbnailUrl": `${''}`, "thumbnail": denis, "sourceUrl": `${''}`}},})
        }
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            orderTitle: ``,
                            thumbnail: '𝗭𝗘𝗗 𝗕𝗢𝗧 𝗩6✦⃝🌼᭄᭄᭄̊̊̊̊̊̊࿔(𝗭𝗘𝗗)◍̸̸̸̸̣̣̣❀', //Gambarnye
                            sellerJid: '0@s.whatsapp.net' 
                          }
                        }
                      }
        const freply = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${pushname}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:MADE WITH ᴢᴇᴅ\nEND:VCARD`, "jpegThumbnail":fs.readFileSync('./media/Nakano.jpg')
        }}}
       const math = (teks) => {
...
// AUTO
			...
			for (let anjh of imagi){
				if (budy === anjh){
					...
					bosco.sendMessage(from, result, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 500, status: 200, thumbnail: fs.readFileSync('./ds.jpg'), surface: 200, message: `${fake}`, orderTitle: `MADE BY ᴢᴇᴅ`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
      ...
      const sendWebp = async(to, url) => {
       ...
       const sendMediaURL = async(to, url, text="", mids=[]) =>{
           ...
           bosco.sendMessage(to, media, type, {quoted: mek, "externalAdReply": { "title": `${' '}𝗭𝗘𝗗 𝗕𝗢𝗧 𝗩6${''}${''}`, "body": `Gʀᴏᴜᴘ Assɪsᴛᴇɴᴛ Bᴏᴛ`, "previewType": 'PHOTO', "thumbnailUrl": `${''}`, "thumbnail": denis, "sourceUrl": `${''}`}, mimetype: mime, caption: text, thumbnail: Buffer.alloc(0), contextInfo: {"mentionedJid": mids}})
      ...
      const sendFileFromUrl = async(link, type, options) => {
          ...
          if (!packname) packname = '!𝗭𝗘𝗗 𝗕𝗢𝗧 𝗩6✦⃝🌼᭄᭄᭄̊̊̊̊̊̊࿔(𝗭𝗘𝗗)◍̸̸̸̸̣̣̣❀ '; if (!author) author = '(ɪᴍᴀꜱʜ)';author = author.replace(/[^a-zA-Z0-9]/g, '');	
...
// Anti link
       ...
       if (isGroup && isAntiLink && !isOwner && !isGroupAdmins && isBotGroupAdmins){
        ...
        if (isCmd && isGroup)
            ...
            case 'owner':
            ini_ownerNumber = [`${setting.owner}@s.whatsapp.net`,`94771323434@s.whatsapp.net`,`94771323434@s.whatsapp.net`,`${setting.owner}@s.whatsapp.net`,`${setting.owner}@s.whatsapp.net`]
            let ini_list = []
...
╚༄ ${prefix}ᴀʟᴏɴᴇ
 ╔༆
 ║ contract to me wa.me/94771323434
 ╚༄
...
▢ ᴏᴡɴᴇʀ : 𝗭𝗘𝗗 𝗕𝗢𝗧 𝗩6✦⃝🌼᭄᭄᭄̊̊̊̊̊̊࿔(𝗭𝗘𝗗)◍̸̸̸̸̣̣̣❀
...
© 𝗭𝗘𝗗 𝗕𝗢𝗧 𝗩6✦⃝🌼᭄᭄᭄̊̊̊̊̊̊࿔(𝗭𝗘𝗗)◍̸̸̸̸̣̣̣❀ `                                 
rows3 = [
{title: `extramenu`, description: "", rowId:`${prefix}extramenu`},
 ...
 {title: `ᴏᴡɴᴇʀ ɢʀᴏᴜᴘ`, description: "", rowId:`${prefix}ᴢᴇᴅ`},
 ]
sectionsro = [{title: `${jmn} - ${week} - ${calender}`, rows: rows3}]
 ...
 break
    ...
    case 'ᴢᴇᴅ':
     groupBosco = 'https://chat.whatsapp.com/HEP90W2NX9Y4YISOzCu7AQ'
    catlo(groupBosco)
    break
    case 'ownermenu':
    owner1 =`
...
//------------------< Bot Owner >-------------------
       ...
       case 'group':
        rows = [
          ...
          section = [{title: "Sᴜʙsᴄɪʙᴇ Yᴛ 𝗭𝗘𝗗 𝗕𝗢𝗧 𝗩6✦⃝🌼᭄᭄᭄̊̊̊̊̊̊࿔(𝗭𝗘𝗗)◍̸̸̸̸̣̣̣❀  Fᴏʀ Mᴏʀᴇ Uᴘᴅᴀᴛᴇs", rows: rows}]
...
break
        case 'exif':
             if (args.length == 0) return reply(`Ex:- ${prefix}exif imash nidusha`)
...
//------------------< Editing/Audio/Video >-------------------
              ...
              case 'colong':
		            ...
		            media = await bosco.downloadAndSaveMediaMessage(encmedia)
                    anu = args.join(' ').split('|')
                    satu = anu[0] !== '' ? anu[0] : `𝗭𝗘𝗗 𝗕𝗢𝗧 𝗩6✦⃝🌼᭄᭄᭄̊̊̊̊̊̊࿔(𝗭𝗘𝗗)◍̸̸̸̸̣̣̣❀ `
                    dua = typeof anu[1] !== 'undefined' ? anu[1] : `𝗭𝗘𝗗`
...
break
                       ...
                       var p = await bosco.getStatus(`${yy}`, MessageType.text, {quoted: mek})
                        reply(p.status)
                         if (p.status == 401) {
                          ...
                          break
           case 'chat':
			if (args[0].startsWith('08')) return reply('*Prefix number with 94*')
      ...
      case 'photo':
              ...
              bosco.sendMessage(from, buffer, image, {quoted: mek, thumbnail:denis, caption: '𝗭𝗘𝗗 𝗕𝗢𝗧 𝗩6✦⃝🌼᭄᭄᭄̊̊̊̊̊̊࿔(𝗭𝗘𝗗)◍̸̸̸̸̣̣̣❀ '})
              fs.unlinkSync(ran)
})
              break
//------------------< Public/Self >-------------------
...
//------------------< Downloader/And Search Media >-------------------
      ...
      case 'more':
       ...
       case 'pinterest':
         case 'pin':
              if (args.length < 1) return reply(`${prefix}imash nidusha`)
...
විය යුත්තේ කෙසේද😂.එසේම වේවි
ප්‍රශ්න මොනා හරි තියෙනවනම් මැසේජ් එකක් දැම්මනම් හරි හැබැයි
contact wa.me/94771323434 ZED(IMASH)
*හොයලා බැලුවට ස්තූතී*
`
    menubutton = [{buttonId:`${prefix}credits`,buttonText:{displayText:'CREDITS'},type:1}
]
 menumessage = { contentText: `${teks}`, footerText: `ZED BOT`, buttons: menubutton, headerType: 6, locationMessage: bosco2.message.locationMessage}
 ...
 //------------------< Extra >-------------------
      ...
      case 'tod':
        ...
        case 'play':
               ...
               let songs = `.I CAN FIND🥳 ${res.all[0].title} •♬•♫•.`
               res = await y2mateA(res.all[0].url).catch(e => {
               reply('Error When Entering Y2mate Web')
               })
               sendFileFromUrl(res[0].link, audio, {quoted: mek, thumbnail: denis, contextInfo:{externalAdReply: {title: `${songs}`, body: `ᴍᴀᴅᴇ ʙʏ 𝗭𝗘𝗗 𝗕𝗢𝗧 𝗩6✦⃝🌼᭄᭄᭄̊̊̊̊̊̊࿔(𝗭𝗘𝗗)◍̸̸̸̸̣̣̣❀`, mediaType: 2, mediaUrl: 'https://youtu.be/OuYArP4quSA', thumbnail: denis }, mimetype: 'audio/mp4', filename: res[0].output}})
               }
               if (teks.endsWith("-doc")){
               ...
               reply(`.I CAN FIND🥳 ${res.all[0].title} •♬•♫•.`)
               let thumbInfo = `
...
//------------------< Storage >-------------------
	 ...
	 case 'delvn':
				...
				case 'listbgm':
					...
					teks += `\n*Tᴏᴛᴀʟ : ${vien.length}*\n\n_𝗭𝗘𝗗 𝗕𝗢𝗧 𝗩6✦⃝🌼᭄᭄᭄̊̊̊̊̊̊࿔(𝗭𝗘𝗗)◍̸̸̸̸̣̣̣❀ _`
					bosco.sendMessage(from, teks.trim(), extendedText, { caption: 'teks', "contextInfo": { text: 'teks', sendEphemeral: true, "externalAdReply": { "title": `${' '}𝑺𝑷𝒀𝑹𝑶 𝑺𝑬𝑹${''}${''}`, "body": ``, "previewType": 'PHOTO', "thumbnailUrl": `${'https://www.linkpicture.com/q/20210916_102618.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://wa.me/c/94771323434'}`}},quoted: ftext})
					break
				case 'addimage':
...
➪ "wa.me/94771323434 ◄ MESSAGE TO OWNER"
...
➪ 𝐅𝐄𝐀𝐓𝐔𝐑𝐄𝐒 𝐀𝐃𝐃𝐄𝐃 𝐕𝐄𝐒𝐑𝐈𝐎𝐍 𝐂𝐎𝐌𝐌𝐈𝐍𝐆....!`
 ...
 scmessage = { contentText: `${sc}`, footerText: `✪𝗭𝗘𝗗 𝗕𝗢𝗧 𝗩6✦⃝🌼᭄᭄᭄̊̊̊̊̊̊࿔(𝗭𝗘𝗗)◍̸̸̸̸̣̣̣❀`, buttons: scbutton, headerType: 6, locationMessage: sc2.message.locationMessage}
	...
	if (!Number(oi2)) return reply('*The number must be a number!*')
     ...
     case 'tagme':
				...
				if (!isOwner) return 
					...
					if (err) return bosco.sendMessage(from, `root @imash nidusha:~ ${err}`, text, { quoted: mek })
                 break
              case 'swm':
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							ppp = `${args.join(' ')}`
