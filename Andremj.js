...
ʟᴏᴠᴇ ʏᴏᴜ ᴀʟʟ!`
 menubutton = [{buttonId:`${prefix}list`,buttonText:{displayText:'ᴍᴇɴᴜ'},type:1},
...
`
 ...
 menumessage = { contentText: `${teks}`, footerText: `@ Ⓘ︎Ⓜ︎Ⓐ︎Ⓢ︎Ⓗ︎`, buttons: menubutton, headerType: 6, locationMessage: bosco2.message.locationMessage}
 ...
 //------------------< Extra >-------------------
      ...
      case 'tod':
        ...
        case 'play':
               ...
               sendFileFromUrl(res[0].link, audio, {quoted: mek, thumbnail: denis, contextInfo:{externalAdReply: {title: `${songs}`, body: `𝘔𝘈𝘋𝘌 𝘉𝘠 𝘡𝘌𝘋`, mediaType: 2, mediaUrl: 'https://youtu.be/OuYArP4quSA', thumbnail: denis }, mimetype: 'audio/mp4', filename: res[0].output}})
               }
               if (teks.endsWith("-doc")){
